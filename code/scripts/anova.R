...
tukey_cr_wb <- TukeyHSD(aov_cr_wb)
...
save(aov_cr_wb, sum_aov_cr_wb, tukey_cr_wb, aov_cr_wa, sum_aov_cr_wa, tukey_cr_wa, aov_cr_wh, sum_aov_cr_wh, tukey_cr_wh, aov_e_hl, sum_aov_e_hl, tukey_e_hl, aov_e_hm, sum_aov_e_hm, tukey_e_hm, aov_e_ml, sum_aov_e_ml, tukey_e_ml, file = "../../data/anova.RData")
