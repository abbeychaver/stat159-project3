...
save(ols_regression_wa, ols_regression_wb, ols_regression_wh, 
     ...
     file="../../data/output/second-model.RData")

# Sinking output to txt file
sink('../../data/output/second-model-output.txt')
