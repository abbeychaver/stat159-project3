...
<<completion rate black white students anova, echo=False, results = tex>>=
library(xtable)
...
<<completion rate table, echo=False, results = tex>>=
...
\caption{\label{fig:TukeyPlot}Tukey Plot Earnings High and Low Income Students}
\end{figure}
