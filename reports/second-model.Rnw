...
<<tables1, fig.width=4, fig.height=4, echo = FALSE, results= tex, fig.pos=H>>=
load(file='../data/second-model.RData')
table1 <- xtable(ols_summary_wa, caption = 'Information about Regression Coefficents of white and asian',digits = 2)

row.names(table1) <- c('(Intercept)','TUTFTE')

print(table1, caption.placement = 'top',comment = getOption("xtable.comment", FALSE))
@

<<tables2, fig.width=4, fig.height=4, echo = FALSE, results= tex, fig.pos=H>>=
table2 <- xtable(ols_summary_wb,caption = 'Information about Regression Coefficents of white and black',digits = 2)

row.names(table2) <- c('(Intercept)','TUTFTE')

print(table2, caption.placement = 'top',comment = getOption("xtable.comment", FALSE))
@

<<tables3, fig.width=4, fig.height=4, echo = FALSE, results= tex, fig.pos=H>>=
load(file='../data/second-model.RData')
table3 <- xtable(ols_summary_wh, caption = 'Information about Regression Coefficents of white and hispanic',digits = 2)
...
<<table4, fig.width=4, fig.height=4, echo = FALSE, results= tex, fig.pos=H>>=
...
table4 <- xtable(results4, caption = 'Regression Quality Indices')
...
<<tables5, fig.width=4, fig.height=4, echo = FALSE, results= tex, fig.pos=H>>=
table5 <- xtable(ols_summary_hl,caption = 'Information about Regression Coefficents of high and low',digits = 2)
...
<<tables6, fig.width=4, fig.height=4, echo = FALSE, results= tex, fig.pos=H>>=
table6 <- xtable(ols_summary_hm,caption = 'Information about Regression Coefficents of high and middle',digits = 2)
...
<<tables7, fig.width=4, fig.height=4, echo = FALSE, results= tex, fig.pos=H>>=
table7 <- xtable(ols_summary_ml,caption = 'Information about Regression Coefficents of middle and low',digits = 2)
...
<<table8, fig.width=4, fig.height=4, echo = FALSE, results= tex, fig.pos=H>>=
...
table8 <- xtable(results8, caption = 'Regression Quality Indices')
...
<<table9, fig.width=4, fig.height=4, echo = FALSE, results= tex, fig.pos=H>>=
...
table9 <- xtable(results9, caption = 'Completion Gap Interception comparsion')

print(table9, caption.placement = 'top', comment = getOption("xtable.comment", FALSE))
@

<<table10, fig.width=4, fig.height=4, echo = FALSE, results= tex, fig.pos=H>>=
Quantity4 <- c('PublicwaIntc', 'PrivatewaIntc','PublicwbIntc', 'PrivatewbIntc', 'PublicwhIntc', 'PrivatewhIntc')
Value4 <- c(ols_coefficients_pbc_wa[2], ols_coefficients_pvt_wa[2], ols_coefficients_pbc_wb[2], ols_coefficients_pvt_wb[2], ols_coefficients_pbc_wh[2], ols_coefficients_pvt_wh[2])

results10 <- data.frame(Quantity4, Value4)

table10 <- xtable(results10, caption = 'Completion Gap Slope comparsion')

print(table10, caption.placement = 'top', comment = getOption("xtable.comment", FALSE))
@

<<table11, fig.width=4, fig.height=4, echo = FALSE, results= tex, fig.pos=H>>=
...
table11 <- xtable(results11, caption = 'Income Gap Interception comparsion')

print(table11, caption.placement = 'top', comment = getOption("xtable.comment", FALSE))
@

<<table12, fig.width=4, fig.height=4, echo = FALSE, results= tex, fig.pos=H>>=
Quantity6 <- c('PublichlIntc', 'PrivatehlIntc','PublichmIntc', 'PrivatehmIntc', 'PublicmlIntc', 'PrivatemlIntc')
Value6 <- c(ols_coefficients_pbc_hl[2], ols_coefficients_pvt_hl[2], ols_coefficients_pbc_hm[2], ols_coefficients_pvt_hm[2], ols_coefficients_pbc_ml[2], ols_coefficients_pvt_ml[2])

results12 <- data.frame(Quantity6, Value6)

table12 <- xtable(results12, caption = 'Income Gap Slope comparsion')
